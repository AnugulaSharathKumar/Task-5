...
############################################
# 2️⃣ Firewall Rules (SSH, HTTP, Health Check)
############################################
...
############################################
# 4️⃣ Instance Template (Ubuntu + Apache)
############################################
...
############################################
# 5️⃣ Managed Instance Group (Auto-healing)
############################################
...
############################################
# 9️⃣ Global Forwarding Rule (Public IP)
############################################
